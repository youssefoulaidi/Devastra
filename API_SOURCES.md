...
- **أصوات المؤذنين**: مجموعة أذان mp3 مستضافة مجانًا على GitHub (`raw.githubusercontent.com/abodehq/Athan-MP3`)
  مع مرآة احتياطية على archive.org لأذان العفاسي. أول صوتين (العفاسي + مكة)
  يُجلبان أيضًا وقت البناء إلى `app/src/main/assets/adhan/` ليُضمَّنا داخل الـ APK ويعملا دون اتصال.
